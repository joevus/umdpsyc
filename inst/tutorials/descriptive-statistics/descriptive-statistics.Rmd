...
Try running the following calculation examples. All you need to do is hit the "Run Code" button.
...
### Another example to work on 

```{r code_sandbox2, exercise=TRUE, exercise.cap="Arithmetic"}
...
```{r test, exercise=TRUE, exercise.cap="UID"}
qplot(1:10)
```

## Another Completing the Tutorial

Write your UID below and hit submit.


```{r UID, exercise=TRUE, exercise.cap="UID"}
qplot(1:10)
```
